...
(function() {
  var ALLOW_MISSING_MINJS, BLACKLIST, CDNJS_ROOT, START_FROM_SCRATCH, async, config, createFileMap, errors, filesDontMatch, findFileRoot, fs, glob, npm, npmNotFound, path, request, tarball, upToDate, updatePackages, updated, verifyFilesExist, writeNpmMap, _,
  ...
  findFileRoot = function(arr) {
    ...
    f2 = arr[arr.length - 1];
    i = 0;
    while (f1.charAt(i) === f2.charAt(i) && i < f1.length) {
      ++i;
    }
